(() => {
  ...
  :host{font:14px/1.6 Aptos,"Segoe UI Variable","Segoe UI","Microsoft YaHei",sans-serif;color:#203b46}*{box-sizing:border-box}button,textarea{font:inherit}button{cursor:pointer;border:0;border-radius:8px;padding:9px 13px;background:#147d97;color:white;transition:transform 160ms ease,filter 160ms ease,background 160ms ease}button:hover{filter:brightness(.96);transform:translateY(-1px)}button:active{transform:translateY(0)}button:disabled{opacity:.5;cursor:not-allowed;transform:none}button:focus-visible,textarea:focus-visible{outline:3px solid #e9b543;outline-offset:2px}#toggle{box-shadow:0 12px 34px #0c415640;padding:12px 18px;font-weight:700}#panel{width:360px;max-width:calc(100vw - 40px);max-height:75vh;overflow:auto;background:linear-gradient(145deg,#ffffff,#f4fafb);border:1px solid #d8e5e9;box-shadow:0 20px 70px #152e4140;border-radius:16px;margin-bottom:12px;padding:18px}header{display:flex;align-items:center;justify-content:space-between}h2{font-size:18px;margin:0;letter-spacing:-.02em}#close,.delete{background:#eef3f4;color:#45626d}#video-title{color:#617c87;overflow-wrap:anywhere;margin:10px 0;font-size:13px}label{display:block;font-size:13px;color:#41616c}textarea{display:block;width:100%;border:1px solid #bcd1d8;border-radius:10px;min-height:92px;resize:vertical;margin:7px 0;padding:10px;color:#203b46;background:white}#stamp{font-size:12px;color:#5c737b;margin:7px 0;overflow-wrap:anywhere}.bar{display:flex;gap:8px;justify-content:space-between}#capture,#export{background:#eef5f6;color:#286072}#status{font-size:12px;min-height:20px;margin:8px 0;color:#526e77}ul{list-style:none;padding:0;margin:8px 0}li{border-top:1px solid #e4edef;padding:12px 0}li p{white-space:pre-wrap;overflow-wrap:anywhere;margin:7px 0}li .row{display:flex;align-items:center;justify-content:space-between}.seek{padding:3px 8px;color:#147d97;background:#e8f4f6;font-weight:700}.delete{font-size:12px;padding:3px 8px}.empty{color:#72848a;font-size:13px}#export{width:100%}[hidden]{display:none!important}
